 ...
 */
final class Version09 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE delegation (id INT AUTO_INCREMENT NOT NULL, workshop_id INT DEFAULT NULL, theme_id INT DEFAULT NULL, user_from_id INT NOT NULL, user_to_id INT NOT NULL, deepness INT DEFAULT NULL, INDEX IDX_292F436D1FDCE57C (workshop_id), INDEX IDX_292F436D59027487 (theme_id), INDEX IDX_292F436D20C3C701 (user_from_id), INDEX IDX_292F436DD2F7B13D (user_to_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE forum (id INT AUTO_INCREMENT NOT NULL, proposal_id INT NOT NULL, parent_forum_id INT DEFAULT NULL, user_id INT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, INDEX IDX_852BBECDF4792058 (proposal_id), INDEX IDX_852BBECDB6011601 (parent_forum_id), INDEX IDX_852BBECDA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE notification (id INT AUTO_INCREMENT NOT NULL, request_id INT DEFAULT NULL, user_id INT NOT NULL, date DATE NOT NULL, subject MEDIUMTEXT NOT NULL, is_read TINYINT(1) NOT NULL, INDEX IDX_BF5476CA427EB8A5 (request_id), INDEX IDX_BF5476CAA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE request (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, user_id INT NOT NULL, is_done TINYINT(1) NOT NULL, INDEX IDX_3B978F9F12469DE2 (category_id), INDEX IDX_3B978F9FA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reset_password_request (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, selector VARCHAR(20) NOT NULL, hashed_token VARCHAR(100) NOT NULL, requested_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', expires_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_7CE748AA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE theme (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, name VARCHAR(40) NOT NULL, image VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, description MEDIUMTEXT NOT NULL, is_public TINYINT(1) NOT NULL, rights_delegation TINYINT(1) NOT NULL, delegation_deepness INT DEFAULT NULL, INDEX IDX_9775E70812469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE website (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, version VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE workshop (id INT AUTO_INCREMENT NOT NULL, theme_id INT NOT NULL, category_id INT DEFAULT NULL, user_id INT NOT NULL, name VARCHAR(50) NOT NULL, description LONGTEXT NOT NULL, date_begin DATE NOT NULL, date_end DATE NOT NULL, rights_see_workshop VARCHAR(1024) NOT NULL, rights_vote_proposals VARCHAR(1024) NOT NULL, rights_write_proposals VARCHAR(1024) NOT NULL, quorum_required INT DEFAULT NULL, rights_delegation TINYINT(1) NOT NULL, image VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, date_vote_begin DATE NOT NULL, date_vote_end DATE NOT NULL, keytext VARCHAR(255) DEFAULT NULL, delegation_deepness INT DEFAULT NULL, INDEX IDX_9B6F02C459027487 (theme_id), INDEX IDX_9B6F02C412469DE2 (category_id), INDEX IDX_9B6F02C4A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

 ...
 */
final class Version20210606112551 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE workshop (id INT AUTO_INCREMENT NOT NULL, theme_id INT NOT NULL, user_id INT NOT NULL, category_id INT DEFAULT NULL, name VARCHAR(50) NOT NULL, description LONGTEXT NOT NULL, date_begin DATE NOT NULL, date_end DATE NOT NULL, rights_see_workshop VARCHAR(1024) NOT NULL, rights_vote_proposals VARCHAR(1024) NOT NULL, rights_write_proposals VARCHAR(1024) NOT NULL, quorum_required INT DEFAULT NULL, rights_delegation TINYINT(1) NOT NULL, image VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, date_vote_begin DATE NOT NULL, date_vote_end DATE NOT NULL, keytext VARCHAR(255) DEFAULT NULL, delegation_deepness INT DEFAULT NULL, INDEX IDX_9B6F02C459027487 (theme_id), INDEX IDX_9B6F02C4A76ED395 (user_id), INDEX IDX_9B6F02C412469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
